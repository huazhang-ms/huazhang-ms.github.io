...
<strong>Hua Zhang</strong>, Yuan Liu, Lauren Fields, Xudong Shi, Penghsuan Huang, Haiyan Lu, Andrew J. Schneider, Xindi Tang, Luigi Puglielli, Nathan V. Welham, Lingjun Li*. (2023). Single-cell lipidomics enabled by dual-polarity ionization and ion mobility-mass spectrometry imaging. Nature Communications, 14: 5185.

<strong>Hua Zhang</strong>, Daniel G. Delafield, Lingjun Li*. (2023). Mass spectrometry imaging: the rise of spatially resolved single-cell omics. Nature Methods, 20(3): 327–330.

<strong>Hua Zhang</strong>, Meng Xu, Xudong Shi, Yuan Liu, Zihui Li, Justin C. Jagodinsky, Min Ma, Nathan V. Welham, Zachary S. Morris, Lingjun Li*. (2021). Quantification and molecular imaging of fatty acid isomers from complex biological samples by mass spectrometry. Chemical Science, 12(23): 8115–8122.

<strong>Hua Zhang</strong>, Xudong Shi, Haiyan Lu, Lingjun Li*. (2025). Delineation of subcellular molecular heterogeneity in single cells via ultralow-flow-rate desorption electrospray ionization mass spectrometry imaging. Analytical Chemistry, 97(18): 9985–9991.
...
<strong>Hua Zhang</strong>, Kelly H. Lu, Malik Ebbini, Penghsuan Huang, Haiyan Lu, Lingjun Li*. (2024). Mass spectrometry imaging for spatially resolved multi-omics molecular mapping. npj Imaging, 20.

<strong>Hua Zhang</strong>, Xudong Shi, Yuan Liu, Bin Wang, Meng Xu, Nathan V. Welham, Lingjun Li*. (2022). On-tissue amidation of sialic acid with aniline for sensitive imaging of sialylated N-glycans from FFPE tissue sections via MALDI mass spectrometry. Analytical and Bioanalytical Chemistry, 414(18): 5263–5274.
